...
from .permissions import IsSupportEmployeeOrReadOnly, IsSaleEmployeeConnectedToTheEventOrReadOnly


class EventViewSet(viewsets.ModelViewSet):
    
    serializer_class = EventSerializer
    permission_classes = [IsAuthenticated, IsSupportEmployeeOrReadOnly, IsSaleEmployeeConnectedToTheEventOrReadOnly]
